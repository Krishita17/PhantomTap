...
Highest-leverage fix first; risk is the projected composite *after* applying each step in sequence.
...
Applying the full roadmap moves this deployment to a projected **20/100**.
